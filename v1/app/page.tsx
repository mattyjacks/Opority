    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="relative bg-background py-20 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-center mb-6 leading-tight animate-slide-up">
            Struggling to Get <span className="dark:gradient-purple-pink gradient-blue bg-clip-text text-transparent animate-gradient">High Paying Clients</span> Consistently?
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-slide-in-left">
              You Don&apos;t Need <span className="dark:gradient-purple-pink gradient-blue bg-clip-text text-transparent animate-gradient">More Clicks</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-slide-in-right">
              Why Your <span className="dark:gradient-purple-pink gradient-blue bg-clip-text text-transparent animate-gradient">Website</span> Isn&apos;t Getting You Clients
            </h2>
      ...
      <section className="py-20 bg-secondary/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 animate-scale-in">
            Stop Chasing Leads. Start Getting <span className="dark:gradient-purple-pink gradient-blue bg-clip-text text-transparent animate-gradient">Clients Who Buy</span>.
          </h2>
          <Link
            href="/strategy-call"
            className="inline-block dark:gradient-purple-pink gradient-blue text-white px-8 py-4 rounded-full text-lg font-semibold transition-all transform hover:scale-110 mt-6 animate-pulse-glow shadow-lg"
          >
            Book Your Free Strategy Call
          </Link>
        </div>
      ...
      <section className="py-20 bg-background relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl font-bold mb-4 animate-scale-in">Ready for <span className="dark:gradient-purple-pink gradient-blue bg-clip-text text-transparent animate-gradient">more clients</span>?</h2>
          <p className="text-xl text-muted-foreground mb-8 animate-slide-up">
            Tap the button below to get started—risk-free.
          </p>
          <Link
            href="/strategy-call"
            className="inline-block dark:gradient-purple-pink gradient-blue text-white px-8 py-4 rounded-full text-lg font-semibold transition-all transform hover:scale-110 animate-pulse-glow shadow-lg animate-float"
          >
            Get More Leads
          </Link>
        </div>
