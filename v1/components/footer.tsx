  ...
  return (
    <footer className="w-full border-t border-border bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {/* Desktop: All 3 sections in a 3-column grid side by side - Company Info | Get In Touch | Quick Links */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
          ...
          {/* Get In Touch - 2nd column of 2-col grid on mobile (right), 2nd column on desktop */}
          <div className="col-span-1 order-2 md:order-2 text-center md:text-left">
          ...
          {/* Quick Links - 1st column of 2-col grid on mobile (left), 3rd column on desktop */}
          <div className="col-span-1 order-1 md:order-3 text-center md:text-left">
